...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-emerald-900/40 bg-slate-950/90 backdrop-blur-md px-3 sm:px-6 lg:px-8 py-2.5 transition-all">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="hidden md:inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold tracking-wide bg-emerald-500/10 text-emerald-300 border border-emerald-500/30">
                COMMAND CENTER
              </span>
            </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 p-1.5 sm:px-3 sm:py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 transition-all cursor-pointer"
            >
              ...
              <div className="text-left hidden md:block">
                ...
                <span className="text-[10px] text-emerald-400 font-mono block">Municipal Admin</span>
              </div>
            ...
            {profileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-slate-900 border border-slate-700 shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-top-2">
                <div className="p-3 border-b border-slate-800 text-xs">
                  ...
                  <div className="mt-1.5 inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-emerald-500/10 text-emerald-300 text-[10px] font-mono border border-emerald-500/30">
